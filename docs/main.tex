...
\csvloop{
    ...
    column count=5,
    column names={1=\testID, 2=\testName, 3=\testInputs, 4=\testOutputs, 5=\testSuccess},
    filter ifthen={\equal{\testID}{$RT_{1}$}\OR\equal{\testID}{$RT_{2}$}\OR\equal{\testID}{$RT_{3}$}\OR\equal{\testID}{$RT_{4}$}\OR\equal{\testID}{$RT_{5}$}\OR\equal{\testID}{$RT_{6}$}\OR\equal{\testID}{$RT_{7}$}\OR\equal{\testID}{$RT_{8}$}\OR\equal{\testID}{$RT_{9}$}\OR\equal{\testID}{\textbf{No.}}},
    before reading={
        \begin{longtable}{|m{1cm}|m{3cm}|m{5cm}|m{5cm}|H}
        \hline
    },
...
\csvloop{
    ...
    late after line=\\\hline,
    after reading={
        \caption{Final Testing Data for Usability}
        \end{longtable}
    }
}
\end{center}
